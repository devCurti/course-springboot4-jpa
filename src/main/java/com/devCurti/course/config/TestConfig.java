...
import com.devCurti.course.entities.Payment;
...
import com.devCurti.course.repositories.ProductRepository;
...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		OrderItem oi4 = new OrderItem(o2, p3, 1, p3.getPrice());
		OrderItem oi5 = new OrderItem(o1, p5, 2, p5.getPrice());
